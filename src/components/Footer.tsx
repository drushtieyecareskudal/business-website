        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div>
            <div className="flex items-center space-x-2 mb-4">
              ...
              <h3 className="text-xl font-bold">Drushti Eye Care</h3>
            </div>
            <p className="text-gray-400 mb-4">
              Providing quality eyewear and eye care services since 1995. We are
              committed to helping you see better and look better.
            </p>
            ...
            <form onSubmit={handleSubscribe} className="space-y-3">
              <div>
                <Input
                  ...
                  className="bg-gray-800 border-gray-700 text-gray-300 focus:border-blue-500"
                  value={email}
